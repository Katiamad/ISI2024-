...
if (!formData.email_receiver.trim()){
 ...
 else if (!formData.email_receiver.trim().endsWith("@uni.com")) {
    errors.email_receiver = "Destination email must end with '@uni.com'";
}
        if (formData.cc.trim())
    if (!validateEmail(formData.cc.trim())){
    ...
    //               setFormErrors({ general: "Une erreur inattendue s'est produite lors de l'inscription." });
    //             }
    //         });
    // }
    const sendEmail = () => {
    ...
    return (
        <div className="page">
            <form className="">
                ...
                <div className="">
                    <label className="">
                        <input name="email_receiver" className="email_receiver" type="email" onChange={onFormChange} placeholder="To" />
    ...
    />
                ...
                <div class="bouttons">
                    <a className="button1" type="submit" onClick={sendEmail}><span>Send</span>  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-telegram" width={24} height={24} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M15 10l-4 4l6 6l4 -16l-18 7l4 2l2 6l3 -4" />
                            </svg>
                    </a>
                    <a className="button2" type="submit" title='Save in drafts' onClick={saveDraft}>Save<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-device-floppy" width={24} height={24} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
